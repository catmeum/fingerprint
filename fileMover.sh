...
NIST_Fingerprints (dir)
TEST (dir)
TRAIN (dir)
'
# Define File paths
FINGERPRINT=~/Desktop/Fingerprint/
NIST=~/Desktop/Fingerprint/NIST_Fingerprints/NISTSpecialDatabase4GrayScaleImagesofFIGS/sd04/png_txt/*
TRAIN_S=~/Desktop/Fingerprint/TRAIN/S/
TRAIN_F=~/Desktop/Fingerprint/TRAIN/F/
...
unzip_NIST() {
	cd $FINGERPRINT
	unzip -d ./NIST_Fingerprints NISTSpecialDatabase4GrayScaleImagesofFIGS.zip
}
